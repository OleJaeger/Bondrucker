...
- **Eigene Druckaufträge** über die REST-API, das Web-Frontend, ein PowerShell-Modul,
  eine Python-Bibliothek/CLI oder einen n8n-Node (siehe
  [`docs/scripts/`](docs/scripts/README.md)).
...
- **Workflow-Automatisierung** über n8n: ein Community-Node (siehe
  [`scripts/n8n/`](scripts/n8n/README.md)) bildet Druckaufträge, Presets, Druckerstatus
  und Vorschau als n8n-Node-Operationen ab.
...
| [`scripts/`](docs/scripts/README.md) | Benutzerhandbuch für die API-Clients (PowerShell-Modul, Python-Bibliothek/CLI, n8n-Node) |
